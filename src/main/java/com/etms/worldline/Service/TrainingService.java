...
public class TrainingService {
    ...
    public Long gettrainerid(String username){
        Long user=userRepository.findByUsername(username).get().getUser_id();
        return trainerRepository.findByUserId(user).get().getId();
    }
    ...
    public List<TrainingsResponse> getAllTrainings() {
        List<TrainingsResponse> trainingsResponses= trainingRepository.getAlltrainings();
        for(TrainingsResponse trainingsResponse:trainingsResponses){
...
//
//    }
public List<User> getSkillApprovedTrainer(String skill_name){
        List<User> users=new ArrayList<>();
    try{
        users=nominationsRepository.getApprovedTrainers(skill_name);
        return users;
    }
    catch (Exception e){
        e.printStackTrace();
