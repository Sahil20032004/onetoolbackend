...
//    }
    ...
    private String getAccessToken() throws IOException {
        GoogleCredentials googleCredentials = GoogleCredentials
                .fromStream(new FileInputStream("C:\\Users\\w136637\\OneDrive - Worldline SA\\Bureau\\sent\\src\\service_account.json"))
                .createScoped(Arrays.asList("https://www.googleapis.com/auth/firebase.messaging"));
        googleCredentials.refresh();
        return googleCredentials.getAccessToken().getTokenValue();
    }
    public ResponseEntity<?> sendNotification(String token,String title,String body) throws IOException{
