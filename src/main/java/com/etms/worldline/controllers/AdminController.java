...
public class AdminController {
    ...
    public ResponseEntity<?> getToken(@RequestBody FcmMessage notifications) throws IOException {
        return userService.sendNotification(notifications.getMessage().getToken(),notifications.getMessage().getNotification().getTitle(),notifications.getMessage().getData().getBody());
    }
