...
//    }
    ...
    @GetMapping("/getCertdetsforMan")
    public List<CertificationsResponse> getCertforMan(@RequestParam @PathVariable Long manager_id){
        return userService.getCertificatesforManager(manager_id);
    }
}
