...
public class UserController {
    ...
    public ResponseEntity<?> saveResponses(HttpServletRequest request,@RequestBody SOSsaveResponses soSsaveResponses){
        soSsaveResponses.setUser_id(jwtTokenProvider.getUserIdFromToken(jwtAuthFilter.getJwtRequest(request)));
    ...
    public ResponseEntity<?> getAnnouncements(@RequestParam @PathVariable String location){
        return sosService.getAnnouncements(location);
    }
}
